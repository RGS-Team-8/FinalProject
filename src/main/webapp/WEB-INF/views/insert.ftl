    ...
    <form data-toggle="validator" role="form" name="registerForm" modelAttribute="insertForm" class="well form-horizontal" action="/admin/owner/insert " method="post" id="register_form">
        ...
        <div class="form-group">
            ...
            <div class="col-md-4 inputGroupContainer">
                <div class="input-group">
                    ...
                    <input name="firstname" placeholder="First name" class="form-control" type="text" id="firstName" pattern="[A-Za-z]+" oninvalid="this.setCustomValidity('Required, please enter your first name.Your first name may only contain lower and upper-case letters.')"
        ...
        <div class="form-group">
            ...
            <div class="col-md-4 inputGroupContainer">
                <div class="input-group">
                    <span class="input-group-addon"><i class="glyphicon glyphicon-user"></i></span>
                    <input name="lastname" placeholder="Last name" class="form-control" type="text" pattern="[A-Za-z]+" oninvalid="this.setCustomValidity('Required, please enter your last name.Your last name may only contain lower and upper-case letters.')" oninput="setCustomValidity('')"
                           required/>
                </div>
                <div class="help-block with-errors"></div>
            </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-4 inputGroupContainer">
                <div class="input-group">
                    ...
                    <input name="ssn" placeholder="SSN" class="form-control" type="text" pattern="[1-9]{1}[0-9]{8}" oninvalid="this.setCustomValidity('Required, please enter your 9-digit SSN.')" oninput="setCustomValidity('')" required>
                </div>
                <div class="help-block with-errors"></div>
            </div>
        </div>
        <div class="form-group">
            ...
            <div class="col-md-4 selectContainer">
                <div class="input-group">
                    ...
                    <select name="typeofuser" class="form-control selectpicker" oninvalid="this.setCustomValidity('Required, choose one option from the list.')" oninput="setCustomValidity('')" required>
